...
extension PreviewSnapshots {
    ...
    ///
    /// - Parameters:
    ///   - snapshotting: Snapshotting instance for  `AnyView` into a `NSImage`.
    ...
    public func assertSnapshots(
        as snapshotting: Snapshotting<AnyView, NSImage>,
    ...
    ///         this function was called.
    public func assertSnapshots(
        as strategies: [String: Snapshotting<AnyView, NSImage>],
        record recording: Bool = false,
        file: StaticString = #file,
        testName: String = #function,
        line: UInt = #line
    ...
    ///         this function was called.
    public func assertSnapshots(
        as strategies: [Snapshotting<AnyView, NSImage>],
        record recording: Bool = false,
        file: StaticString = #file,
        testName: String = #function,
        line: UInt = #line
...
extension PreviewSnapshots {
    ...
    ///
    /// - Parameters:
    ///   - snapshotting: Snapshotting instance that converts an `AnyView` into a `NSImage`.
    ///   - recording: Whether or not to record a new reference.
    ///   - file: The file in which failure occurred. Defaults to the file name of the test case in
    ///         which this function was called.
    ///   - testName: The name of the test in which failure occurred. Defaults to the function name
    ...
    public func assertSnapshots<Modified: View>(
        as snapshotting: Snapshotting<Modified, NSImage>,
        record recording: Bool = false,
        file: StaticString = #file,
        testName: String = #function,
        line: UInt = #line,
    ...
    ///   - modify: A closure to update the preview content before snapshotting.
    public func assertSnapshots<Modified: View>(
        as strategies: [Snapshotting<Modified, NSImage>],
        record recording: Bool = false,
        file: StaticString = #file,
        testName: String = #function,
        line: UInt = #line,
